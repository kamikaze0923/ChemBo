...
# for i in {1..$n_exp_runs}; do python experiments/run_chemist.py -d chembl -s 3 -o logp -b 100 -k distance_kernel_expsum -i 10 -stp 20 -mpl 1000; done
# for i in {1..$n_exp_runs}; do python experiments/run_chemist.py -d chembl -s 3 -o logp -b 100 -k similarity_kernel -i 10 -stp 20 -mpl 1000; done
# for i in {1..$n_exp_runs}; do python experiments/run_explorer.py -d chembl -s 3 -o logp -b 100 -i 10 -mpl 1000; done
