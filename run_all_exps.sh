...
for i in {1..$n_exp_runs}; do python experiments/run_chemist.py -d chembl -s 3 -o qed -b 100 -k distance_kernel_expsum -i 30 -stp 10 -mpl 1000; done
for i in {1..$n_exp_runs}; do python experiments/run_chemist.py -d chembl -s 3 -o qed -b 100 -k similarity_kernel -i 30 -stp 100 -mpl 1000; done
for i in {1..$n_exp_runs}; do python experiments/run_explorer.py -d chembl -s 3 -o qed -b 100 -i 30 -mpl 1000; done

echo -e "\tLogP+ChEMBL:"

for i in {1..$n_exp_runs}; do python experiments/run_chemist.py -d chembl -s 3 -o logp -b 100 -k distance_kernel_expsum -i 30 -stp 10 -mpl 1000; done
for i in {1..$n_exp_runs}; do python experiments/run_chemist.py -d chembl -s 3 -o logp -b 100 -k similarity_kernel -i 30 -stp 100 -mpl 1000; done
for i in {1..$n_exp_runs}; do python experiments/run_explorer.py -d chembl -s 3 -o logp -b 100 -i 30 -mpl 1000; done
